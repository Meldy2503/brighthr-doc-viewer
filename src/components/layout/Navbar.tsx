...
export const Navbar: React.FC<NavbarProps> = ({ isSidebarCollapsed }) => {
  ...
  return (
    <div
      className={`fixed top-0 right-0 left-[60px] z-30 bg-topbar border-b border-border px-4 lg:px-9 h-[72px] flex items-center justify-between transition-all duration-300 ${
